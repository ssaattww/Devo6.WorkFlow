...
| P3 | 進行中 | 中核プロジェクト、公開 API、逐次実行、実行結果契約の実装。 | T10-T13 が検査先行で実装、検査、点検され、E2E が成立しにくい箇所でも公開 API または利用者目線の検査を先に置き、公開 API と実行中核の提出可能な状態になる。 | T10 完了、`tasks-status.md` T10-T13、`reports/t10-project-skeleton-implementation-20260606171737.md`、`reports/t10-project-skeleton-review-20260606171737.md` |
